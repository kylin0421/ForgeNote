...
if not (project_root / "pyproject.toml").exists():
    raise RuntimeError("Run PyInstaller from the ForgeNote repository root")

debug_build = os.environ.get("FORGENOTE_PYINSTALLER_DEBUG") == "1"

datas = [
    (str(project_root / "forgenote" / "database" / "migrations"), "forgenote/database/migrations"),
    (str(project_root / "forgenote" / "ai" / "assets"), "forgenote/ai/assets"),
]
...
hiddenimports = (
    ...
    + collect_submodules("forgenote.ai")
