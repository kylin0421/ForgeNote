...
- SurrealDB 2.6.5 — Business Source License 1.1 and the additional licenses
  identified by the project:
  https://github.com/surrealdb/surrealdb/tree/v2.6.5
- FFmpeg 8.1.2 essentials build by Gyan Doshi — GPLv3 build. Build details and
  corresponding FFmpeg source revision are published at:
