...
interface ChatPanelProps {
  ...
  notebookId?: string
  // Optional live activity generated by chat tool calls.
  composerActivity?: ReactNode
  // Cached/demo surfaces can keep the production composer without backend note actions.
              ...
              messages.map((message) => (
                ...
                >
                  ...
                  <div className="flex flex-col gap-2 max-w-[80%]">
                    ...
                    {message.type === 'ai' && showMessageActions && (
                      <MessageActions
                        content={message.content}
                        notebookId={notebookId}
                        onSaveToNote={onSaveMessageToNote}
                      />
                    )}
                  </div>
                  {message.type === 'human' && (
