export const zhCN = {
  ...
  advanced: {
    ...
    updateAvailableDesc: "ZhiXue 的新版本可用。",
    upToDate: "已是最新",
    unknown: "未知",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "按学习用途配置 ZhiXue 的默认模型",
    missingRequiredModels: "缺少必需的模型：{models}。如果没有这些模型，ZhiXue 可能无法正常运行。",
