export const enUS = {
  common: {
    ...
    accessibility: {
      ...
      searchNotebooks: "Search learning records",
    },
    url: "URL",
  ...
  connectionErrors: {
    ...
    apiDesc: "The ZhiXue API server could not be reached",
  ...
  notebooks: {
    ...
    activeNotebooks: "Active Learning Records",
    archivedNotebooks: "Archived Learning Records",
    tileView: "Tile view",
    listView: "List view",
  ...
  settings: {
    ...
    filesHelp: "Once your files are uploaded and processed, they are not required anymore. Most users should allow ZhiXue to delete uploaded files from the upload folder automatically.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "A new version of ZhiXue is available.",
    upToDate: "Up to Date",
    unknown: "Unknown",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Assign default models by ZhiXue learning workflow purpose",
    missingRequiredModels: "Missing required models: {models}. ZhiXue may not function properly without these.",
    ...
    conversationModelLabel: "Conversation Tutor",
    conversationModelDesc: "Used for notebook chat and instant tutoring.",
    ...
    assetSpecificModels: "Asset-specific generation",
    ...
    retrievalModelLabel: "Retrieval LLM",
    retrievalModelDesc: "Used by LLM-BM25 for summary indexing, query rewriting, and reranking. Falls back to transformation/chat when unset.",
