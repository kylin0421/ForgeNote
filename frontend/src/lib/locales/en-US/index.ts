export const enUS = {
  ...
  searchPage: {
    ...
    vectorSearchWarning: "The current retrieval backend requires an embedding model. Only text search is available.",
