export const enUS = {
  ...
  podcasts: {
    ...
    generateExplainerVideo: "Also generate an explainer video",
    generateExplainerVideoDesc: "The script plans key visuals, then generated images are aligned to the real speech timeline and composed locally as MP4 without a video API.",
    ...
    explainerTaskStarted: "Podcast and explainer video task started",
    explainerVideo: "Explainer video",
    videoUnavailable: "The explainer video is temporarily unavailable.",
    videoGenerationFailed: "Podcast audio completed, but explainer video generation failed",
    keyframesCount: "{count} key visuals aligned to the real speech timeline.",
