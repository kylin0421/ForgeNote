export const zhTW = {
  ...
  models: {
    ...
    defaultAssignmentsDesc: "按學習用途設定 ZhiXue 的預設模型",
    missingRequiredModels: "缺少必需的模型：{models}。如果没有這些模型，ZhiXue 可能無法正常運行。",
    selectModelPlaceholder: "選擇一個模型",
    requiredModelPlaceholder: "⚠️ 必需 - 請選擇一個模型",
    chatModelLabel: "聊天模型",
    chatModelDesc: "用於聊天對話",
    conversationModelLabel: "對話與輔導模型",
    conversationModelDesc: "用於筆記本對話和即時學習輔導。",
    ragModelLabel: "RAG 問答模型",
    ragModelDesc: "用於基於來源和筆記進行問答。",
    resourceSearchModelLabel: "資源搜尋智能體模型",
    resourceSearchModelDesc: "用於規劃 Web 搜尋並重排學習資源。",
    learningAssetModelLabel: "通用資產生成模型",
    learningAssetModelDesc: "所有學習資產生成的預設兜底模型。",
    assetSpecificModels: "按資產類型指定生成模型",
    studyGuideModelLabel: "學習講解文件",
    studyGuideModelDesc: "生成長篇 Markdown 講解。",
    quizModelLabel: "測驗題",
    quizModelDesc: "生成診斷題和練習題。",
    flashcardsModelLabel: "閃卡",
    flashcardsModelDesc: "生成可翻閱的記憶卡片。",
    mindMapModelLabel: "知識導圖",
    mindMapModelDesc: "生成 Mermaid 相容的知識結構圖。",
    readingModelLabel: "延伸閱讀",
    readingModelDesc: "生成延伸閱讀指南。",
    codeLabModelLabel: "程式實驗",
    codeLabModelDesc: "生成實作程式案例和實驗。",
    podcastScriptModelLabel: "播客腳本",
    podcastScriptModelDesc: "生成播客大綱和對話腳本。",
    voiceModels: "語音與音訊模型",
  ...
  apiKeys: {
    ...
    description: "將 API 金鑰安全地儲存在資料庫中，以在 ZhiXue 中啟用 AI 服務商。",
