...
from forgenote.domain.base import ObjectModel
...
async def vector_search(
    ...
    if not keyword:
        raise InvalidInputError("Search keyword cannot be empty")
    try:
        from forgenote.utils.embedding import generate_embedding
...
async def semantic_search(
    ...
    if not keyword:
        raise InvalidInputError("Search keyword cannot be empty")
    try:
        from forgenote.utils.semantic_index import configured_semantic_search
