...
Encryption is enabled when FORGENOTE_ENCRYPTION_KEY environment variable
...
from forgenote.database.repository import ensure_record_id, repo_query, repo_upsert
from forgenote.domain.base import RecordModel
from forgenote.utils.encryption import decrypt_value, encrypt_value
...
class ProviderConfig(RecordModel):
    ...
    record_id: ClassVar[str] = "forgenote:provider_configs"
    ...
    def _prepare_save_data(self) -> dict:
        ...
        FORGENOTE_ENCRYPTION_KEY is configured.
        """
        data = {"credentials": {}}
    ...
    async def save(self) -> "ProviderConfig":
        ...
        await repo_upsert("forgenote", self.record_id, data)
        return self
