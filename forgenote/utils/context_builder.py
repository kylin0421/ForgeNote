"""
Generic ContextBuilder for the ForgeNote project.
...
from forgenote.domain.notebook import Note, Notebook, Source
from forgenote.exceptions import DatabaseOperationError, NotFoundError
