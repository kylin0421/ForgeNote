...
def install_cancellation_guard() -> None:
    ...
    if getattr(CommandService, "_forgenote_cancel_guard_installed", False):
        return
    ...
    CommandService._forgenote_cancel_guard_installed = True
    logger.info("Installed ForgeNote command cancellation guard")
